...
use Triangle\OAuth\Base\OAuthUtil;
...
abstract class OAuth1 extends AbstractAdapter implements AdapterInterface
{
    ...
    protected function authenticateFinish()
    {
        ...
        $denied = request()->get('denied') !== null && is_string(request()->get('denied')) ? request()->get('denied') : '';
        $oauth_problem = request()->get('oauth_problem') !== null && is_string(request()->get('oauth_problem')) ? request()->get('oauth_problem') : '';
        $oauth_token = request()->get('oauth_token') !== null && is_string(request()->get('oauth_token')) ? request()->get('oauth_token') : '';
        $oauth_verifier = request()->get('oauth_verifier') !== null && is_string(request()->get('oauth_verifier')) ? request()->get('oauth_verifier') : '';
